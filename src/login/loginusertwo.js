...
class UserTwoLogin extends Component {
    constructor(props){
        super(props);
        this.state = {
            username: '',
                                    ...
                                    <div className="form-custom">
                                        ...
                                        <li className="list-inline-item" >
                                            ...
                                            >
                                                ...
                                                <span className="network-name">User 2 Login</span>
                                            </button>
                                        </li>

                                        <h1 className="message">{this.state.info}</h1>
                                        <NavLink to='/login/user1'>Sign In with User 1 Credentials</NavLink>
...
export default withRouter(UserTwoLogin);